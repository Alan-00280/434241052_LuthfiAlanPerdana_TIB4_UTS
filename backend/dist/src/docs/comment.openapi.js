...
import z from "zod";
import { TicketCommentSchema } from "../../prisma/zod/index.js";
    ...
    responses: {
        200: {
            content: {
                'application/json': {
                    schema: z.object({
                        comments: z.array(z.any()).openapi({ description: 'Daftar komentar tiket' }),
                    }),
                },
            },
    ...
    request: {
        ...
        body: {
            content: {
                'application/json': {
                    schema: z.object({
                        authorId: z.string().openapi({ description: 'ID User pembuat komentar' }),
    ...
    responses: {
        201: {
            content: {
                'application/json': {
                    schema: z.object({
                        comment: z.any().openapi({ description: 'Objek komentar yang berhasil dibuat' }),
                    }),
                },
            },
...
export const deleteCommentRoute = createRoute({
    ...
    description: 'Menghapus komentar (hanya bisa dilakukan oleh pembuat komentar atau ADMIN).',
    security: [
        {
            BearerAuth: [],
        }
