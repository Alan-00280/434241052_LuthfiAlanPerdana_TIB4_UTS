...
* **File Storage:** Supabase Storage (untuk attachment tiket)
    ...
    tags: [
        {
            name: 'Auth',
            description: 'Fitur Autentikasi: Login, Register, Logout, dan manajemen token JWT.'
        },
        {
            name: 'Tickets',
            description: 'Manajemen pembuatan tiket oleh User, serta validasi, assignment, dan tracking status oleh Admin/Helpdesk.'
        },
        {
            name: 'Comments',
            description: 'Fitur komunikasi real-time berupa feedback/balasan komentar antara User dan tim Support pada tiket terkait.'
        },
        {
            name: 'Health Check',
            description: 'Endpoint monitoring untuk memastikan status engine server Helpdesk API aktif.'
        }
    ],
});
